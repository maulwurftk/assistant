-- ============================================================================
-- 0010 · provision_tenant() — transaktionales Onboarding (Architektur §4.1)
-- Org + Admin-Profil in EINER Transaktion; verhindert Zombie-Accounts
-- (Auth-User ohne Tenant) und Doppel-Provisionierung. Idempotent (or replace).
-- Aufruf: unmittelbar nach supabase.auth.signUp() vom Client via rpc().
-- ============================================================================
